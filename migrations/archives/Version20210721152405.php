 ...
 */
final class Version20210721152405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cartline DROP produit_id, CHANGE quantity quantity INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cartline ADD produit_id INT NOT NULL, CHANGE quantity quantity INT DEFAULT NULL');
